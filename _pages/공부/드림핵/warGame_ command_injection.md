...
![설명]({{ 'assetsimgcommand1_0.png' | relative_url }})

**ping page**

![설명]({{ 'assetsimgcommand1_1.png' | relative_url }})
...
![설명]({{ 'assetsimgcommand1_2.png' | relative_url }})

개발자모드를 들어가 코드를 확인해보면,

![설명]({{ 'assetsimgcommand1_3.png' | relative_url }})

input값에 들어가는 입력값 기준을 설정해놓은게 보인다.

그러면 패턴 부분을 지우면 된다.

![설명]({{ 'assetsimgcommand1_4.png' | relative_url }})

다시 input 값에 8.8.8.8; ls #을 입력하면 이렇게 뜬다.

![설명]({{ 'assetsimgcommand1_5.png' | relative_url }})
...
![설명]({{ 'assetsimgcommand1_6.png' | relative_url }})
